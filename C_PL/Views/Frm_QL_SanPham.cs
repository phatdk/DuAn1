...
namespace C_PL.Views
{
    public partial class Frm_QL_SanPham : Form
    {
        ...
        public void LoadSanPham()
        {
            ...
            dtg_view_sanpham.AllowUserToAddRows = false;
        ...
        {
            if (tb_tensp.Text == "" || tb_mota.Text == "" || cbb_loaisp.Text == "" || tb_giaban.Text == "" || cbb_trangthai.Text == "") return false;
            return true;
        }
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            else if (Convert.ToInt32(tb_giaban.Text) < 0)
            {
        ...
        private void btn_sua_Click(object sender, EventArgs e)
        {
            ...
            var lsp = _iloaiSpSer.GetAllLoaiSp().FirstOrDefault(c => c.TenLoai == cbb_loaisp.Text);
            var ten = _isanPhamSer.GetAllSanPham().FirstOrDefault(p => p.TenSp == tb_tensp.Text);
            if (tensp != tb_tensp.Text && ten != null)
            {
