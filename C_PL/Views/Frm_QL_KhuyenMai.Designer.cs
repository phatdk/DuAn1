namespace C_PL.Views
{
	partial class Frm_QL_KhuyenMai
	{
		...
		private void InitializeComponent()
		{
			...
			groupBox1.Size = new Size(903, 536);
			...
			groupBox4.Size = new Size(547, 422);
			...
			groupBox2.Size = new Size(352, 512);
			...
			// btn_clear
			// 
			btn_clear.Location = new Point(265, 39);
			btn_clear.Margin = new Padding(2, 2, 2, 2);
			btn_clear.Name = "btn_clear";
			btn_clear.Size = new Size(80, 27);
			...
			// btn_xoa
			// 
			btn_xoa.Location = new Point(180, 39);
			btn_xoa.Margin = new Padding(2, 2, 2, 2);
			btn_xoa.Name = "btn_xoa";
			btn_xoa.Size = new Size(80, 27);
			btn_xoa.TabIndex = 2;
			btn_xoa.Text = "Xóa";
			...
			// btn_sua
			// 
			btn_sua.Location = new Point(95, 39);
			btn_sua.Margin = new Padding(2, 2, 2, 2);
			btn_sua.Name = "btn_sua";
			btn_sua.Size = new Size(80, 27);
			btn_sua.TabIndex = 1;
			btn_sua.Text = "Sửa";
			...
			// btn_them
			// 
			btn_them.Location = new Point(10, 39);
			btn_them.Margin = new Padding(2, 2, 2, 2);
			btn_them.Name = "btn_them";
			btn_them.Size = new Size(80, 27);
			btn_them.TabIndex = 0;
			btn_them.Text = "Thêm";
